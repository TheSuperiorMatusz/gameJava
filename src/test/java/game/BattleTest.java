...
class BattleTest {
    ...
    private static Stream<Arguments> provideArmiesForBattle(){
        ...
        firstArmy.addUnits(WarriorWithWeapon:: new,1);
        Army secondArmy = new Army();
        secondArmy.addUnits(WarriorWithWeapon:: new,2);
        Army thirdArmy = new Army();
        thirdArmy.addUnits(WarriorWithWeapon:: new,2);
        Army fourthArmy = new Army();
        fourthArmy.addUnits(WarriorWithWeapon:: new,3);
        Army fithArmy = new Army();
        fithArmy.addUnits(WarriorWithWeapon:: new,5);
        Army sithArmy = new Army();
        sithArmy.addUnits(WarriorWithWeapon:: new,7);
        Army seventhArmy = new Army();
        seventhArmy.addUnits(WarriorWithWeapon:: new,20);
        Army eightArmy = new Army();
        eightArmy.addUnits(WarriorWithWeapon:: new,21);
        Army ninthArmy = new Army();
        ninthArmy.addUnits(WarriorWithWeapon:: new,10);
        Army tenthArmy = new Army();
        tenthArmy.addUnits(WarriorWithWeapon:: new,11);
        Army eleventhArmy = new Army();
        eleventhArmy.addUnits(WarriorWithWeapon:: new,11);
        Army twelvethArmy = new Army();
        twelvethArmy.addUnits(WarriorWithWeapon:: new,7);
        Army thirteenthArmy = new Army();
        thirteenthArmy.addUnits(WarriorWithWeapon::new,5);
        thirteenthArmy.addUnits(Defender::new,4);
        thirteenthArmy.addUnits(Defender::new,5);
        Army fourteenthArmy = new Army();
        fourteenthArmy.addUnits(WarriorWithWeapon::new,4);
        Army fiftteenthArmy = new Army();
        fiftteenthArmy.addUnits(Defender::new,5);
        fiftteenthArmy.addUnits(WarriorWithWeapon::new,20);
        fiftteenthArmy.addUnits(Defender::new,4);
        Army sixteenthArmy = new Army();
        sixteenthArmy.addUnits(WarriorWithWeapon::new,21);
        Army seventeenthArmy = new Army();
        Army eighteemteenth = new Army();
        seventeenthArmy.addUnits(WarriorWithWeapon::new,10);
        seventeenthArmy.addUnits(Defender::new,5);
        eighteemteenth.addUnits(WarriorWithWeapon::new,5);
        ...
        nineteenthArmy.addUnits(WarriorWithWeapon::new,1);
        nineteenthArmy.addUnits(Defender::new,1);
        twentythArmy.addUnits(WarriorWithWeapon::new,5);
        Army twentyFirst = new Army();
        Army twentyTwo = new Army();
        twentyFirst.addUnits(Defender::new,5);
        twentyFirst.addUnits(Vampire::new,6);
        twentyFirst.addUnits(WarriorWithWeapon::new,7);
        twentyTwo.addUnits(WarriorWithWeapon::new,6);
        ...
        twentyThird.addUnits(WarriorWithWeapon::new,4);
        twentyFourth.addUnits(WarriorWithWeapon::new,4);
        ...
        twentyFifth.addUnits(WarriorWithWeapon::new,4);
        twentySixt.addUnits(WarriorWithWeapon::new,4);
        ...
        twentySeventh.addUnits(WarriorWithWeapon::new,8);
        twentyEight.addUnits(WarriorWithWeapon::new,4);
