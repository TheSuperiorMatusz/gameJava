...
public class StraightBattleTest {
    ...
    private static Stream<Arguments> provideArmiesForStraightBattle(){
        ...
        thirdArmy.addUnits(WarriorWithWeapon::new,4);
        thirdArmy.addUnits(Defender::new,2);
        fourhtArmy.addUnits(WarriorWithWeapon::new,4);
        ...
        fifthArmy.addUnits(WarriorWithWeapon::new,4);
        fifthArmy.addUnits(Healer::new,1);
        fifthArmy.addUnits(Defender::new,2);
        sixthArmy.addUnits(WarriorWithWeapon::new,4);
        ...
        seventhArmy.addUnits(WarriorWithWeapon::new,3);
        seventhArmy.addUnits(Healer::new,1);
        seventhArmy.addUnits(WarriorWithWeapon::new,4);
        seventhArmy.addUnits(Healer::new,1);
        seventhArmy.addUnits(Knight::new,2);
        eightArmy.addUnits(WarriorWithWeapon::new,4);
